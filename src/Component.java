...
public class Component implements Rotatable, Nameable, UpdatingDisplayable,
   ...
   * 
   * @see edu.bu.cs.cs480.Displayable#draw(GL)
   */
  @Override
   ...
   *          The OpenGL object with which to perform the drawing.
   * 
   * @see edu.bu.cs.cs480.Displayable#initialize(GL)
   */
  @Override
   ...
   *          The OpenGL object with which to perform the drawing.
   * 
   * @see edu.bu.cs.cs480.UpdatingDisplayable#update(GL)
   */
  @Override
  ...
  public void setReverseAngles(Angled angled) {
      this.setAngles(-angled.xAngle(), -angled.yAngle()-180, angled.zAngle());
  }

  public void setClawAngles(Angled angled) {
    this.setAngles(180-angled.xAngle(), angled.yAngle(), angled.zAngle());
  }

//  public void setClawMiddleAngles(Angled angled) {
//    this.setAngles(-angled.xAngle(), -angled.yAngle(), angled.zAngle());
//  }
